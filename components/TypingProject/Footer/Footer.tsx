...
const ClickableIcon = (props: Props) => {
  return (
    <a href={props.href} className="" target={"_blank"} rel="noreferrer">
      <props.Icon
        className={
          "w-5 h-5 text-gray-400 hover:text-[#f5d14e] transition duration-800 fill-current hover:cursor-pointer "
        }
      />
    </a>
  );
  ...
  return (
    ...
    text-sm  space-y-2  "
        >
          ...
          <span className="text-xs flex flex-row items-center space-x-2 group-hover:text-[#f5d14e]">
            <InstagramIcon
              className={
                "w-4 h-4 text-gray-400 fill-current group-hover:text-[#f5d14e] duration-800"
              }
            />
