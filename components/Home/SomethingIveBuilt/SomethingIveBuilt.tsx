  ...
  return (
    ...
    >
      ...
      <div data-aos="fade-up" className=" flex flex-row  items-center md:px-0">
        <ArrowIcon className={"flex-none h-5 md:h-6 w-5 md:w-5 translate-y-[2px] text-[#f5d14e]"} />
        <div className="flex-none flex-row space-x-2 items-center pr-2">
          <span className="text-[#f5d14e] font-sans text-sm  sm:text-xl"> 03.</span>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1  z-10">
                <span className="text-[#f5d14e] text-base">Vision.io</span>
                <a href="https://www.vision.io" target="_blank" rel="noopener noreferrer">
                  <span className=" md:text-gray-200 text-[#f5d14e] font-bold text-xl hover:cursor-pointer">
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-left ">
                  At <span className="text-[#f5d14e]">Vision</span>, I played a crucial role in developing web3
                  components for their <span className="text-[#f5d14e]">web3 application</span> using Next.js and web3
                  libraries. Our focus was on integrating new features and improving the user interface. One notable
                  achievement was the release of NameWrapper with <span className="text-[#f5d14e]">ERC72</span>{" "}
                  support, enabling users to create <span className="text-[#f5d14e]">subdomains</span>. This showcased
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-[#f5d14e] text-base">Recent Project</span>
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  ...
                  project, including the <span className="text-[#f5d14e]"> design</span> and implementation of the{" "}
                  <span className="text-[#f5d14e]"> smart contract</span> and{" "}
                  <span className="text-[#f5d14e]"> blockchain technology</span>. Here i share with you{" "}
                  <span className="text-[#f5d14e]"> YPredict - v1 </span> for the private sale.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left">
                  ...
                  platform with scalable <span className="text-[#f5d14e]"> smart contracts</span> and{" "}
                  <span className="text-[#f5d14e]"> blockchain technology</span>. This platform,{" "}
                  <span className="text-[#f5d14e]"> FeverTokens - v2</span>, was showcased at the VivaTech2022 event
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                  This project aim to help you to improve your <span className="text-[#f5d14e]"> typing </span> by
                  tracking your progress in <span className="text-[#f5d14e]"> each round</span> and give you a{" "}
                  <span className="text-[#f5d14e]"> score</span> based on your typing speed and accuracy through a
                  table of <span className="text-[#f5d14e]"> statistics</span>.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  ...
                  <span className="text-[#f5d14e]"> location</span>,{" "}
                  <span className="text-[#f5d14e]">IP Address</span>,{" "}
                  <span className="text-[#f5d14e]">{","} software, Hardware</span> and some additional information
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96">
          ...
          >
           ...
           transition-opacity opacity-50 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <div className="absolute px-2 bg-AAprimary rounded  ml-4 mt-2 ">
                <span className="text-[#f5d14e] text-xl">In initiation...</span>
              </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full   rounded  ml-4 mt-2  text-end pr-8">
              ...
              <span className="text-[#f5d14e] sm:text-lg bg-AAprimary px-2 py-1 rounded">In initiation...</span>
            </div>
            <div
              className="px-8 pt-8 sm:pt-12 md:py-0 xl:col-span-6 xl:col-start-7 col-start-5 
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                  It&apos; a barber shop <span className="text-[#f5d14e]">appointment scheduling</span> & management
                  software it provides <span className="text-[#f5d14e]">online scheduling</span>, appointment
                  reminders, <span className="text-[#f5d14e]">payments</span>, marketing, and much more! Currently in
                  the <span className="text-[#f5d14e]">Initiation phase</span>.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96  ">
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  A <span className="text-[#f5d14e]">JavaFX call center management system</span> project it is used
