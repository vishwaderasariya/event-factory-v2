  ...
  return (
    ...
    >
      <a href={props.href} className="" target={"_blank"} rel="noreferrer">
        <props.Icon className={"w-6 h-6 text-gray-400 hover:text-[#f5d14e] fill-current hover:cursor-pointer"} />
      </a>
    </motion.div>
  );
};
        ...
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          >
            <a href="mailto:abdellatif@anaflous.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-[#f5d14e] hover:cursor-pointer">
